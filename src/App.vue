...
<template>
  <Drawer v-if="cartOpen" :total-price="totalPrice" :discount-price="discountPrice" @create-order="createOrder" is-creating-order="isCreatingOrder"/>
  ...
  <div class="bg-white w-4/5 mx-auto rounded-xl shadow-xl mt-14">
    ...
    <div class="p-10">
      ...
      <div class="mt-10">
        <CardListVue :items="items" @add-to-favorire="addToFavorites" @add-to-cart="onClickAddPlus"/>
      </div>
    </div>
  </div>
</template>
